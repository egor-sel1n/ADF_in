...
#define  ADF7021_MODULE_CE      GPIOA, GPIO_PIN_0
#define  ADF7021_MODULE_SLE     GPIOA, GPIO_PIN_1
#define  ADF7021_MODULE_SDATA   GPIOA, GPIO_PIN_2
#define  ADF7021_MODULE_SREAD   GPIOA, GPIO_PIN_3
#define  ADF7021_MODULE_SCLK    GPIOA, GPIO_PIN_4
...
#define  ADF7021_MODULE_PAC_M1     GPIOB, GPIO_PIN_12 // M1 ģ���PAC��
#define  ADF7021_MODULE_PAC_M2     GPIOB, GPIO_PIN_2    // M2 ģ���PAC��

#define  ADF7021_MODULE_CE_M1      GPIOB, GPIO_PIN_1   // M1 ģ���CE��
...
//--------------------- �����Ǻ������� ---------------------
void adf7021_register_write( uint32_t reg_value, uint8_t SN );
uint16_t adf7021_register_read( uint16_t readback_mode, uint8_t SN );
